...
## [v8.37.0-1] - 2026-09-18
### Changed
- [#81] Update Gotenberg to v8.37.0
- [#81] Update base image to v3.24.1-3

### Security
- [#81] Fix [CVE-2026-57433](https://nvd.nist.gov/vuln/detail/CVE-2026-57433)

## [v8.36.0-1] - 2026-08-31
### Changed
- [#79] Update Gotenberg to v8.36.0
...
## [v8.34.0-1] - 2026-06-16
### Changed
- [#72] Update Gotenberg to v8.34.0
- [#72] Update base-image to v3.24.0-1
- [#72] Update Makefiles to v10.9.1

## [v8.33.0-1] - 2026-06-03
### Changed
- [#70] Update Gotenberg to v8.33.0
- [#70] Update Makefiles to v10.9.0

## [v8.31.0-1] - 2026-04-20
### Changed
- [#63] Update Gotenberg to v8.31.0

## [v8.30.1-1] - 2026-04-09
### Changed
- [#61] Update Gotenberg to v8.30.1
...
- [#57] Update base image to v3.23.3-6
- [#57] Update Makefiles to v10.7.2
### Security
- [#57] Vulnerability fixed: [CVE-2026-2781](https://avd.aquasec.com/nvd/2026/cve-2026-2781/)

## [v8.27.0-3] - 2026-03-16
### Security
- [#55] CVE fixed: [CVE-2026-3913](https://avd.aquasec.com/nvd/2026/cve-2026-3913/)

## [v8.27.0-2] - 2026-03-09
### Security
- [#53] CVE fixed: [cve-2026-3061](https://avd.aquasec.com/nvd/2026/cve-2026-3061/)
- [#53] CVE fixed: [cve-2026-3062](https://avd.aquasec.com/nvd/2026/cve-2026-3062/)
- [#53] CVE fixed: [cve-2026-2781](https://avd.aquasec.com/nvd/2026/cve-2026-2781/)

## [v8.27.0-1] - 2026-02-25
### Changed
...
## [v8.25.1-2] - 2026-01-19
### Changed
- [#44] Update Makefiles to v10.5.0
### Security
- [#44] Fixes [CVE-2026-0861](https://avd.aquasec.com/nvd/2026/cve-2026-0861)
